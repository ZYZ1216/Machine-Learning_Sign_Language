...
df_reduced = pd.read_csv(csv_file_path_reduced_pca)
...
save_results_to_file('model_results_plain_pixel_pca.txt', 'KNN', accuracy_knn, report_knn)
...
save_results_to_file('model_results_plain_pixel_pca.txt', 'Naive Bayes', accuracy_nb, report_nb)
...
save_results_to_file('model_results_plain_pixel_pca.txt', 'Random Forest', accuracy_rf, report_rf)
